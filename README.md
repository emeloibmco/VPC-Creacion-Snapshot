...
La presente guía muestraslos pasos que se deben realizar para generar un *Snapshot* que permita crear una copia del volumen arranque de *Block Storage* de una *VSI* en *VPC*.
